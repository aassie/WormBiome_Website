...
blastUI<- function(ida, custom_db,wb,phylo,ugenome){
  ...
  fluidPage(
    ...
    fluidRow(column(12,
      ...
      downloadButton(NS(ida, "downloadBlastData"), "Download Blast Summary", class = "custom-button"),
      ...
      fluidRow(
        column(6,
               numericInput(
                 ...
                 step = 500)),
        column(6,
               downloadButton(NS(ida, "downloadBlastContext"), "Download Blast Context", class = "custom-button"))
        ),
